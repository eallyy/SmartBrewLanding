...
const features = [
  {
    ...
    description:
      "Create your perfect cup in minutes. Adjust variables like grind size, brew time, and water temperature to craft the ideal brew.",
    image: screenshotRecipeCreator,
  },
  {
    title: 'Brew Analysis',
    description:
      "Analyze your brewing process with detailed insights. Track extraction levels, temperature consistency, and more.",
    image: screenshotBrewAnalysis,
  },
  {
    title: 'Recipe Library',
    description:
      "Access a growing library of coffee recipes tailored to your equipment and taste preferences. Save and revisit your favorites.",
    image: screenshotRecipeLibrary,
  },
  {
    title: 'Optimize',
    description:
      "Optimize your recipe based on user feedback and brewing data. Perfect every cup with AI-powered suggestions.",
