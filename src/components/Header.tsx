...
function MobileNavigation({
  ...
  return (
    <Popover>
      ...
      >
        <MobileNavLink href={sectionHref('features')}>Features</MobileNavLink>
        <MobileNavLink href={sectionHref('testimonials')}>
          Testimonials
        </MobileNavLink>
        <MobileNavLink href={sectionHref('pricing')}>Pricing</MobileNavLink>
        <hr className="m-2 border-slate-300/40" />
        <MobileNavLink href="https://app.smartbrew.co/">Login</MobileNavLink>
      </PopoverPanel>
    </Popover>
  )
}
        ...
        <nav className="relative z-50 flex justify-between">
          ...
          <div className="flex items-center gap-x-5 md:gap-x-8">
            ...
            <div className="-mr-1 md:hidden">
              <MobileNavigation sectionHref={sectionHref} />
            </div>
          </div>
        </nav>
      </Container>
